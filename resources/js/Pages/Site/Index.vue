                            ...
                            <div class="swiper-slide">
                                <div class="hero__slider--items home1-slider1-bg">
                                    <div class="slider__content">
                                        ...
                                        <h2 class="slider__maintitle h1">{{ product.title }} <br>
                                            <span class="slider__maintitle--inner__text">{{
                                                    product.description
                                                }}</span>
                                        </h2>
                                        <span class="slider__price--text text__secondary">{{ product.price }}/$</span>
                                        <a class="primary__btn slider__btn" href="{{ product.slug }}">
                                            Shop now
            ...
            <div class="container">
                <div class="discount__banner--thumbnail">
                    <a class="display-block position-relative" href="#">
                        <img class="discount__banner--thumbnail__img" src="/site/assets/img/banner/discount-bg.webp"
                             alt="banner-img">
            ...
            <div class="container">
                <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
                    ...
                    <ul class="nav tab__btn--wrapper" role="tablist">
                        ...
                        <li class="tab__btn--item" role="presentation">
                            <button class="tab__btn--link" data-bs-toggle="tab" data-bs-target="#bestseller"
                                    type="button"
                        ...
                        <div class="col-lg-4">
                            <div class="sidebar__category">
                                <div class="choose__category--content">
                                    <h2 class="choose__category--title">Выберите категорию</h2>
                                        ...
                                        <template v-for="category in categories">
                                            <li class="choose__category--menu__list">
                                                ...
                                                <Link
                                                    ...
                                                    class="choose__category--menu__link font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                                    {{ category.title }}
                                                </Link>
                                            </li>
                                        </template>
                                                    ...
                                                    <article class="product__card">
                                                        ...
                                                        <div class="product__card--content">
                                                            ...
                                                            <div class="product__card--footer">
                                                                ...
                                                                <a class="product__card--btn primary__btn mt-3"
                        ...
                        <div class="small__product--step">
                            ...
                            <div class="small__product--step__inner">
                                <div class="small__product--card style2 d-flex mb-25">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="product-details.html"><img
                                            src="/site/assets/img/product/small-product/product6.webp"
                                            alt="product-img"></a>
                                    </div>
                                    <div class="small__product--content">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Lorem
                                            ipsum
                                            dolor. </a></h3>
                                        <div class="product__card--price">
                                ...
                                <div class="small__product--card style2 d-flex mb-25">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="product-details.html"><img
                                            src="/site/assets/img/product/small-product/product7.webp"
                                            alt="product-img"></a>
                                    </div>
                                    <div class="small__product--content">
                                        <ul class="rating small__product--rating d-flex">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Consec
                                            adipis
                                            elit. </a></h3>
                                        <div class="product__card--price">
                                ...
                                <div class="small__product--card style2 d-flex">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="product-details.html"><img
                                            src="/site/assets/img/product/small-product/product9.webp"
                                            alt="product-img"></a>
                                    </div>
                                    <div class="small__product--content">
                                        <ul class="rating small__product--rating d-flex">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Labore
                                            qui
                                            corpos. </a></h3>
                                        <div class="product__card--price">
                            ...
                            <div class="small__product--step__inner">
                                <div class="small__product--card style2 d-flex mb-25">
                                    ...
                                    <div class="small__product--content">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Maiores
                                            delec
                                            ipsam. </a></h3>
                                        <div class="product__card--price">
                                ...
                                <div class="small__product--card style2 d-flex mb-25">
                                    ...
                                    <div class="small__product--content">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Suscip
                                            esse
                                            commo. </a></h3>
                                        <div class="product__card--price">
                                ...
                                <div class="small__product--card style2 d-flex">
                                    ...
                                    <div class="small__product--content">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Recusand
                                            cum
                                            quas? </a></h3>
                                        <div class="product__card--price">
                            ...
                            <div class="small__product--step__inner">
                                <div class="small__product--card style2 d-flex mb-25">
                                    ...
                                    <div class="small__product--content">
                                        ...
                                        <h3 class="small__product--card__title"><a href="product-details.html">Beata
                                            saepe
                                            sint. </a></h3>
                                        <div class="product__card--price">
                                ...
                                <div class="small__product--card style2 d-flex mb-25">
                                    <div class="small__product--thumbnail">
                                        <a class="display-block" href="product-details.html"><img
                                            src="/site/assets/img/product/small-product/product5.webp"
                                            alt="product-img"></a>
                                    </div>
                                    <div class="small__product--content">
                                        <ul class="rating small__product--rating d-flex">
