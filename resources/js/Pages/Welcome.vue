    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            ...
            <template v-else>
                ...
                <!--  Переходим в админку в шаблоны blade  -->
                <a :href="route('admin.index')"
                   class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Админка</a>
